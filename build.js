...
return Promise.resolve()
  ...
  .then(() => Promise.resolve()
    .then(() => _relativeCopy('**/*.d.ts', tempLibFolder, distFolder))
  ...
  .then(() => {
    ...
    const rollupBaseConfig = {
      ...
      plugins: [
        ...
        alias({
          'ng2-qgrid/core': path.join(tempLibFolder, '/core/'),
          'ng2-qgrid/plugin': path.join(tempLibFolder, '/plugin/'),
          'ng2-qgrid': path.join(es2015OutputFolder, '/src/')
        })
      ]
    };
